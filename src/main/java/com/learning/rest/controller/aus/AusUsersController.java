package com.learning.rest.controller.aus;
...
// http://localhost:8080/twoServletDispatcher/aus/user/zubin/28/837

@RestController
@RequestMapping(value = "/user")
public class AusUsersController {
